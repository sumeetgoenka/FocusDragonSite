...
const faqs = [
  {
    ...
    a: "FocusDragon is the most bypass-resistant free option. It's the only free Mac blocker that also blocks apps, survives reboots, uses six independent blocking layers, and offers six lock modes. SelfControl is a close runner-up if you only need a simple website timer.",
  },
  {
    q: "Are free website blockers as good as paid ones?",
    a: "In 2026, yes. FocusDragon specifically is free and matches or exceeds paid tools like Cold Turkey ($39) and Freedom ($8.99/mo) on most dimensions — six blocking layers, native macOS enforcement, root daemon, and six lock modes. The author built it to solve his own gaming addiction and released it free on principle.",
  },
  {
    q: "Why would a blocker be free? What's the catch?",
    a: "FocusDragon has no paid tier, no ads, no account system, and collects no telemetry by default. It was built by a solo developer who wanted to help people with the same problem he had. Hosting costs are a few dollars a month. There is no catch.",
  },
  {
    q: "Is there a free website blocker that blocks apps too?",
    a: "Only FocusDragon. Most free Mac blockers (SelfControl, StayFocusd, /etc/hosts edits) only cover websites. FocusDragon runs a process-killer that terminates blocked apps every 1.5 seconds.",
  },
];
...
const tools = [
  {
    rank: 1,
    name: "FocusDragon",
    tagline: "The toughest free blocker for Mac",
    price: "Free forever",
    strengths: ["6 blocking layers", "6 lock modes", "Blocks apps", "Root daemon", "Survives uninstall during locks"],
    weaknesses: ["Mac-only", "No cross-device sync"],
    verdict: "Best free choice, period. If you only need a blocker on your Mac, nothing free comes close.",
    cta: true,
    link: "/",
  },
  {
    rank: 2,
    name: "SelfControl",
    tagline: "Classic open-source website timer",
    price: "Free (open source)",
    strengths: ["Open source", "Simple UI", "Mac-native", "Won't cancel early"],
    weaknesses: ["Websites only, no apps", "Bypassed by DNS change / safe mode", "Single lock type"],
    verdict: "Great for a one-off timer block. Weak for serious use.",
    link: "/vs/selfcontrol",
  },
  {
    rank: 3,
    ...
    price: "Free (included)",
    strengths: ["Zero install", "Syncs to iOS", "Good for family"],
    weaknesses: ["One click to disable if you know the passcode", "Unreliable outside Safari", "Not meant for self-blocking"],
  ...
  },
  {
    ...
    verdict: "Placebo. Good for forming gentle habits, not for breaking compulsions.",
    link: "/block-websites-on-mac",
  },
  {
    rank: 5,
    ...
    weaknesses: ["Two terminal commands to undo", "Changing DNS bypasses it", "Useless against apps"],
    verdict: "Free but trivially bypassed.",
    link: "/block-websites-on-mac",
  },
];
